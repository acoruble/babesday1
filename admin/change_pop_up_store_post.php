...
if(isset($_FILES["image"]) && $_FILES["image"]["error"] == 0) {
  ...
  $update = $bdd->prepare('UPDATE popupstore
  SET surname = :surname, name = :name, description = :description, facebook = :facebook, instagram = :instagram, etsy = :etsy, otherAccount = :otherAccount, image = :image
  WHERE id = :id');
