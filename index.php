        ...
        <div class="container-fluid box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center align-items-center">
              <li class="nav-item active"><a class="nav-link smooth-link" href="#home">Accueil</a></li>
              ...
              <li class="nav-item hidden-md-down"><a class="nav-link smooth-link" href="https://www.facebook.com/BABESDAYFR/"><img src="img/FB_ico.png" alt="Facebook BabesDay 2019" aria-label="Facebook BabesDay 2019"  /></a>
                <li class="nav-item hidden-md-down"><a class="nav-link smooth-link" href="https://twitter.com/babesvoices"><img src="img/Twitter_ico.png" alt="Twitter BabesDay 2019" aria-label="Twitter BabesDay 2019" /></a>
                  <li class="nav-item hidden-md-down"><a class="nav-link smooth-link" href="https://www.instagram.com/babesdayfr/?fbclid=IwAR2epW3H5nbH7-syKuh8Oea7PxYvWsT6MvPBX5_J8J1FgoDz1iDV7cuD5mM"><img src="img/Insta_ico.png" alt="Instagram BabesDay 2019" aria-label="Instagram BabesDay 2019" /></a>
                    <li class="nav-item hidden-md-down"><a class="nav-link smooth-link" href="https://www.linkedin.com/company/18691047/"><img src="img/LinkedIn_ico.png" alt="LinkedIn BabesDay 2019" aria-label="LinkedIn BabesDay 2019" /></a>
                    </ul>
                    <ul class="nav-right text-center text-lg-right py-4 py-lg-0">
                      <li class="nav-item"><a class="nav-link smooth-link 300" title="Billeterie des BabesDay 2019" href="#billeterie">Billeterie</a></li>
                    </ul>
                  </div>
                </div>
              </nav>
          ...
          <section class="section-padding--small bg-primary-red pt-5" >
            <div class="container">
              ...
              <div class="col-lg-12 mt-4" tabindex="0" aria-labelledby="">
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                          ...
                          <div id="day1" class="tab-pane active">
                              ...
                              <div class="row no-gutters">
                                <div class="col-md-3">
                                  <div class="card-talk justify-content-center p-3">
                                    <img src="img/home/Informations.png" alt="">
                                  </div>
                                </div>
                            ...
                            <div class="schedule-card">
                              <div class="row no-gutters">
                                <div class="col-md-3">
                                  <div class="card-talk">
                                    <em class="fas fa-microphone-alt fa-4x mb-3"></em>
                                    <div>
                                      <h3>WARM-UP</h3>
                                      <p>19h-22h</p>
                                    </div>
                            ...
                            <div class="row no-gutters">
                              <div class="col-md-3">
                                <div class="card-talk d-flex justify-content-center align-items-center">
                                  <img src="img/home/Informations.png" alt="" style="width: 100px;">
                                </div>
                              </div>
                              <div class="col-md-9 align-self-center">
                                <div class="schedule-content">
                              ...
                              <div class="row no-gutters">
                                <div class="col-md-3">
                                  <div class="card-talk d-flex justify-content-center align-items-center p-3">
                                    <img src="img/partenaires/partners-claping-hands.png" alt="" style="border-radius: 0;">
                                  </div>
                                </div>
                                <div class="col-md-9 align-self-center">
                        ...
                        <section class="section-padding--small bg-primary-rose mb-5">
                          <div class="container">
                            <div class="section-intro text-center">
                              ...
                              <p class="color-black title-2 " tabindex="0">Mise en ligne le 12 Aout</p>
                            </div>
                            <div class="sponsor-wrapper ">
                              <div class="row">
                        ...
                        <section id="social" class="bg-primary-yellow pb-5">
                          <div class="container-fluid">
                            ...
                            <div class="row align-items-center mt-5">
                              ...
                              <!--                                <div class="bg-primary-yellow pb-2 flex-column">-->
                              <!--                                    <a href="https://www.facebook.com/BABESDAYFR/" class="d-flex justify-content-start align-items-center face text-lg-right"><img src="img/FB_ico.png" alt="Facebook BabesDay 2019" aria-label="Facebook BabesDay 2019"  /><span class="text-uppercase ml-4 text-white">Facebook</span></a>-->
                              <!--                                    <a href="https://twitter.com/babesvoices" class="d-flex justify-content-start align-items-center tweet text-lg-right ml-4"><img src="img/Twitter_ico.png" alt="Facebook BabesDay 2019" aria-label="Facebook BabesDay 2019"  /><span class="text-uppercase ml-4 text-white">Twitter</span></a>-->
                              <!--                                    <a href="https://www.instagram.com/babesdayfr/?fbclid=IwAR2epW3H5nbH7-syKuh8Oea7PxYvWsT6MvPBX5_J8J1FgoDz1iDV7cuD5mM" class="d-flex justify-content-start align-items-center insta text-lg-right"><img src="img/Insta_ico.png" alt="Facebook BabesDay 2019" aria-label="Facebook BabesDay 2019 "  /><span class="text-uppercase ml-4 text-white">Instagram</span></a>-->
                              <!--                                    <a href="https://www.linkedin.com/company/18691047/" class="d-flex justify-content-start align-items-center linkedin text-lg-right ml-4"><img src="img/LinkedIn_ico.png" alt="Facebook BabesDay 2019" aria-label="Facebook BabesDay 2019"  /><span class="text-uppercase ml-4 text-white">LinkedIn</span></a>-->
                              <!--                                </div>-->
                              <!--                          </div>-->
                              <!--                      </div>-->
                              <!--              </div>-->
                                  ...
                                  <form action="traitements/news.php" method="post" class="subscription relative">
                                    <div class="input-group d-flex flex-row">
                                      ...
                                      <button class="btn bb-btn">
                                        <i aria-hidden="true" class="far fa-check-square fa-2x" title="Valider le formulaire"></i>
                                    ...
                                    <!--                                  </div>-->
                                    <!--                                  <label>Vous acceptez de recevoir nos communications par email</label>-->
                                    <!--                              </div>-->
                                    <!--                          </div>-->
                      ...
                      <script src="vendors/jquery.instagramFeed.min.js"></script>
                      <script src="vendors/bootstrap/bootstrap.bundle.min.js"></script>
                      <script src="vendors/owl-carousel/owl.carousel.min.js"></script>
                      <script src="vendors/bootstrap-swipe-carousel.min.js"></script>
